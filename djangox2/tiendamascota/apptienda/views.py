...
from .forms import ProductoForm, ClienteForm, CustomUserCreationForm
...
def detallada(request):
    return render (request, 'detallada.html')
...
def registrarse(request):
    ...
    if request.method== 'POST':
        ...
        if formulario.is_valid():
            ...
            login(request, user)
            messages.SUCCESS(request, "haz sido registrado correctamente ")
